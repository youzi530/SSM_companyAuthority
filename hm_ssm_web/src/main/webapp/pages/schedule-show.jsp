            ...
            <section class="content"> <!--产品信息-->
                ...
                <div class="panel panel-default">
                    ...
                    <div class="row data-type">
                        ...
                        <div class="col-md-2 title">请投票</div>
                        <div class="col-md-4 data">
                            <select class="form-control select2" style="width: 100%"
                                    name="isvote">
                                <option value="1" selected="selected">赞成</option>
                                <option value="2">反对</option>
                            </select>
                        </div>

                        <div class="col-md-2 title">投票者</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" placeholder="投票者"
                                   name="owener" value= <security:authentication property="principal.username"></security:authentication>>
                        </div>

                        <%--value=<%= SecurityContextUtil.getCurrentUser().getUserName() %>--%>
                    </div>
                </div>
                <!--订单信息/--> <!--工具栏-->
